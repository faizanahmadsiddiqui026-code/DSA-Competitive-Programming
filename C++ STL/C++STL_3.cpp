...
using namespace std;
int main(){
// // Bitset (not datatype it is a container)
// 	// int -> 16 bits=2 bytes
// 	// char -> 8 bits=1 byte
// 	int a[100]; //space taken by int arr is way more than the char arr
// 	char a[100]; 
 
// 	// bitset -> 1 bit=1/8 byte
 
//space taken by bitset array is way less than int array
//bitset is used in segment tree
//contiguous memory allocation

// 	bitset<5> bt; //array kind of structure forms array of size=5 ,0-based indexing, only stores 1 or 0 
// 	cin >> bt; // 10111  goes into the bt of size=5
...
// 	cout << bt.all(); // returns a true if all bit are set or a false if any of the bit is unset
 


// 	// any 
//if atleast any of the 1 bit is set then it will print true else false
// bt -> 10011
// 	cout << bt.any(); // true 
